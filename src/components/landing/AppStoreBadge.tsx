...
/** Official-style "Download on the App Store" badge, rendered inline so it
 * needs no external asset. Only shown once APP_STORE_URL is set. */
const AppStoreBadge = ({ className = "" }: { className?: string }) => {
  ...
  return (
    <a
      ...
      aria-label="Download Blasto on the App Store"
    ...
    >
      ...
      <span className="text-left leading-tight">
        <span className="block text-[0.65rem] uppercase tracking-wide opacity-80">Download on the</span>
